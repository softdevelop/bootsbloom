...
{
	case 'boostbloom.com':
	case 'www.boostbloom.com':
		$env_name = 'production';
		break;
		
	case 'stage.boostbloom.com':
		$env_name = 'staging';
		break;
		
	case 'boostbloom.local':
		$env_name = 'local2';
		break;
		
	default:
		if(stripos(__DIR__, 'httpdocs') !== false)
		{
			$env_name = 'production';
		}
		else if(stripos(__DIR__, 'stage') !== false)
		{
			$env_name = 'staging';
		}
		else if(stripos(__DIR__, 'wamp') !== false)
		{
			$env_name = 'local2';
		}
		else
...
Configure::write('cake_env', $env_name);
switch($env_name)
{
	case 'production':
