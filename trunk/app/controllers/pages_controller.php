...
class PagesController extends PagesAppController
{
    ...
    public $uses = array( "Pages.Page", "Project", "ProjectCancellationRequest" );
        ...
        if( !empty($this->data) ) 
        {
            if( $lang == "eng" ) 
            {
                ...
                if( $this->Page->validates() ) 
                {
                    ...
                    $this->Session->setFlash(__d("pages", "Please complete franch tab too.", true), "admin/success");
        ...
        if( !empty($this->data) ) 
        {
            if( $lang == "eng" ) 
            {
                ...
                if( $this->Page->validates() ) 
                {
                    ...
                    $this->Page->save($this->data, false);
                    $this->Session->setFlash(__d("pages", "Please complete edit franch tab too.", true), "admin/success");
