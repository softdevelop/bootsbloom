<?php
echo $this->Form->create($model, array('url' => array('action' => 'admin_add_blog_category', $blog_id)));
echo $this->Form->hidden('blog_id', array('value' => $blog_id));
?>
<div class="ochead" >
    <div class="floatleft" id="breadcrumb">Add <?php
if (isset($blog)) {
...
<?php } ?>
        ...
        <tr class="even_row">
            ...
            <td width="1%" valign="top">:</td>
            <td ><?php echo $form->textarea($model . '.description', array('label' => '', 'class' => 'ui-widget-content ui-corner-all', 'style' => 'width:250px;height:50px;')); ?></td>
            <td width="30%" valign="middle">
