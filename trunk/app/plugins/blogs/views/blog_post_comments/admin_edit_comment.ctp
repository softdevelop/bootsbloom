<?php
echo $this->Form->create($model, array("url" => array("action" => "admin_edit_comment", $id, $blog_id)));
...
<?php echo $this->Html->link("Back To Comment", array('plugin' => 'blogs', 'controller' => 'blog_post_comments', 'action' => 'index', $post_id, $blog_id), array("class" => 'back_lnk')); ?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
...
<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr class="odd_row" ">
            <td align='left' width="19%" valign="top" class="padding_left_40">Comment<font color='red'>*</font></td>
            <td width="1%" valign="top">:</td>
            <td > <?php echo $form->textarea($model . '.comment', array('label' => '', 'class' => 'ui-widget-content ui-corner-all', 'style' => 'width:250px;height:50px;')); ?></td>
            <td width="30%" valign="middle">
<?php if (isset($this->validationErrors[$model]['comment'])) { ?>
                    <div  class="errormsg">
                        <div class="floatleft padright_10px padtop_4px"><img src="<?php echo WEBSITE_URL; ?>img/error_icon.gif" width="10" height="10" alt="" /></div>
                        <div class="floatleft"><?php echo $this->validationErrors[$model]['comment']; ?></div>
                        <div class="clear"></div>
                        <div class="errtl"></div>
                        <div class="errtr"></div>
                        <div class="errbl"></div>
            ...
            <td align='left' colspan="4" style="padding:10px 0px 10px 200px">
                <table>
                    <tr><td>
                        ...
                        <td><?php
                            echo $html->link('Cancel', array('plugin' => 'blogs', 'controller' => 'blog_post_comments', 'action' => 'index', $post_id, $blog_id), array('escape' => false, 'class' => 'cancel_lnk'));
                            ?></td>
                    </tr>
                </table>
            </td>
