<script>
    $(function(){
       $("#allow_commnet").selectmenu() ;
    });
</script>
<?php echo $this->Form->create($model,array("url"=>array("action"=>"admin_edit_post",$id,$parent_id)));
		echo $this->Form->hidden('parent_id',array('value'=>$parent_id)); 
		echo $this->Form->hidden('id',array('value'=>$id));
?>	
<div class="ochead" >
    <div class="floatleft" id="breadcrumb">Edit <?php if(isset($blog)){ 
    ...
    <div class="floatright padtop_6px">
        ...
        <div class="floatleft " style="font-size:10px;">
           <?php  echo $this->Html->link("Back",array('plugin'=>'blogs','controller' => 'blog_posts', 'action' => 'index',$parent_id),array("class"=>'back_lnk'));?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
		...
		<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
			<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
				...
				<tr class="even_row">
					...
					<td ><?php 
						echo $form->textarea($model.'.description', array('label' => '','class'=>'ui-widget-content ui-corner-all','style'=>'width:250px;height:50px;'));
				...
				<tr class="odd_row">
					...
					<td width="1%" valign="top">:</td>
					<td>
						<?php echo $form->Select("blog_category_id",$category_list,null,array('empty' =>'Select category',"class" => "ui_dropdown")); ?>
					</td>
					<td width="30%" valign="middle">
				...
				<tr class="odd_row"><td colspan="4"><?php echo $html->image('admin/dot.gif',array('alt'=>'','width'=>'1px','height'=>'10px'));?></td></tr> 
				<tr class="odd_row">
					<td align='left' valign="top" class="padding_left_40">Allow Comment<font color='red'>*</font></td>
					<td width="1%" valign="top">:</td>
					<td>
						<?php echo $form->input('allow_comment',array('label' => '','options' => array('empty' =>'Select category','0'=>'Not Allowed','1'=>'Allowed'), null,'id'=>'allow_commnet'));  ?>
					</td>
					<td width="30%" valign="middle">
				...
				<tr class="even_row">
					<td align='left' colspan="4" style="padding:10px 0px 10px 200px">
						<table>
							...
							<td><?php					
							echo $html->link('Cancel', array('plugin'=>'blogs','controller' => 'blog_posts', 'action' => 'index',$parent_id), array('escape' => false,'class'=>'cancel_lnk'));
								?></td>
							</tr>
						</table>
					</td>
