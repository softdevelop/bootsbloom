<?php
echo $this->Form->create($model, array("action" => "add"));
echo $this->Html->script('/groups/js/groups.js');
?>
<div class="ochead">
    <div class="floatleft padtop_20px">New User Group</div>
    <div class="floatright padtop_6px">
        <div class="floatleft padright_10px" style="font-size:10px;">
			<?php echo $this->Html->link("Back To Groups", array("plugin" => "groups", "controller" => "groups", "action" => "index"), array("class" => 'back_lnk')); ?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
...
<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr class="odd_row">
            <td align='left' width="19%" valign="top" class="padding_left_40"> Group Name<font color='red'>*</font></td>
        ...
        <tr class="even_row">
            <td align='left' colspan="4" style="padding:10px 0px 10px 200px">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr><td><?php echo $form->submit('Submit', array('border' => '0', 'class' => 'submit_button')); ?></td></tr>
                </table>
            </td>
        </tr>
    </table>
