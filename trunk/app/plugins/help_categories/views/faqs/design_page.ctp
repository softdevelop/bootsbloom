      ...
      <div>
        <div class="fl wid_305 aligncenter">
          ...
          <div class="color_code">
				<strong><?php __('CMYK'); ?>: </strong>	<span>4, 0, 98, 0</span><br>
				<strong><?php __('Hex'); ?>:</strong> 	<span>#F5FF05</span><br>
				<strong><?php __('RGB'); ?>:</strong> 	<span>245, 255, 5</span><br> 
          </div>
        </div>
        <div class="fl pl47 wid_305 aligncenter">
          ...
          <div class="clr pt20"></div>
          <div class="color_code">
				<strong><?php __('CMYK'); ?>: </strong>	<span>100, 45, 0, 0</span><br>
				<strong><?php __('Hex'); ?>:</strong> 	<span>#008AFF</span><br>
				<strong><?php __('RGB'); ?>:</strong> 	<span>0, 138, 255</span><br> 
        ...
        <div class="fr wid_305 aligncenter">
          ...
          <div class="clr pt20"></div>
          <div class="color_code">
				<strong><?php __('CMYK'); ?>: </strong>	<span>93, 12, 0, 0</span><br>
				<strong><?php __('Hex'); ?>:</strong> 	<span>#11D4F3</span><br>
				<strong><?php __('RGB'); ?>:</strong> 	<span>17, 212, 243</span><br> 
