...
<div class="ochead">
    ...
    <div class="floatleft padtop_20px">Edit Post</div>
    <div class="floatright padtop_6px">
        <div class="floatleft padright_10px" style="font-size:10px;">
            <?php echo $this->Html->link("Back To Categories", array("plugin" => "help_categories", "controller" => "school_posts", "action" => "admin_index", $parent_id), array("class" => 'back_lnk')); ?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
    ...
    <div id="tab1" class="tab_content">
        <div class="wrapper">
            <div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <?php echo $this->Form->create($model, array('url' => array('plugin' => 'help_categories', 'controller' => 'school_posts', 'action' => 'edit_post', $id, $parent_id, 'eng'))); ?>
                <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
                    ...
                    <tr class="even_row">
                        ...
                        <td width="1%" valign="top">:</td>
                        <td ><?php 
							echo $form->textarea($model . '.description', array('label' => '', 'class' => 'ui-widget-content ui-corner-all', 'style' => 'width:640px;height:480px;')); 
...
<?php /* second tab start here */ ?>
    ...
    <div id="tab2" class="tab_content">
        <div class="wrapper">
            <div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <?php
                echo $this->Form->create($model, array('url' => array('plugin' => 'help_categories', 'controller' => 'school_posts', 'action' => 'edit_post', $id, $parent_id, 'hy')));
