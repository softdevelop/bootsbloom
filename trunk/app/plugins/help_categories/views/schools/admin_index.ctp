   ...
   <?php }else{ 
    ...
    <div class="floatright padtop_6px">
        ...
        <div class="floatleft" style="font-size:10px;">
            ...
            <?php echo $this->Html->link("Add Category", array("plugin" => "help_categories", "controller" => "schools", "action" => "add_category",$parent_id), array("class" => 'add_lnk')); ?>
        </div>
        <div class="clear"></div>
    </div>
...
<div class="pagging float_right ">
   <?php echo $this->Form->create($model,array('url'=>array('plugin'=>'help_categories','controller' => 'schools', 'action' => 'index',$parent_id)));
 ?>
    <?php //echo $form->text('category_name', array('placeholder' => 'Category', 'class' => 'status ui-widget-content ui-corner-all')); ?>
...
<?php echo $this->element("admin/school"); ?>