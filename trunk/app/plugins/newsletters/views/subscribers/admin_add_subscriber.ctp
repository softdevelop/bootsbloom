<?php echo $this->Form->create($model,array("class"=>"form-horizontal",'onsubmit' => 'return ValidateEmail();')); ?>
<div class="ochead">
    <div class="floatleft" id="breadcrumb">Add Subscriber </div>
...
<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
		...
		<tr class="odd_row">
			...
			<td ><?php echo $form->text($model.'.email', array('label' => '','class'=>'ui-widget-content ui-corner-all'));?></td>
