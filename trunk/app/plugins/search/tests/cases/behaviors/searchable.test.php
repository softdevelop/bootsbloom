...
{
    public function mostFilterConditions($Model, $data = array(  ))
    {
        $filter = $data["filter"];
...
class Article extends CakeTestModel
{
    ...
    public function findByTags($data = array(  ))
    {
        ...
        $query = $this->Tagged->getQuery("all", array( "conditions" => array( "Tag.name" => $data["tags"] ), "fields" => array( "foreign_key" ), "contain" => array( "Tag" ) ));
        return $query;
    }
    ...
    {
        $filter = $data["filter"];
        $cond = array( "OR" => array( $this->alias . ".title LIKE" => "%" . $filter . "%", $this->alias . ".body LIKE" => "%" . $filter . "%" ) );
        return $cond;
    }
...
{
    public $fixtures = array( "plugin.search.article", "plugin.search.tag", "plugin.search.tagged" );
    ...
    {
        $this->Article->filterArgs = array( array( "name" => "slug", "type" => "value" ) );
        $data = array(  );
        ...
        $this->Article->filterArgs = array( array( "name" => "fakeslug", "type" => "value", "field" => "Article2.slug" ) );
        $data = array( "fakeslug" => "first_article" );
        $result = $this->Article->parseCriteria($data);
        $expected = array( "Article2.slug" => "first_article" );
        $this->assertEqual($result, $expected);
        $this->Article->filterArgs = array( array( "name" => "views", "type" => "value" ) );
        $data = array( "views" => "0" );
        $result = $this->Article->parseCriteria($data);
    ...
    {
        $this->Article->filterArgs = array( array( "name" => "title", "type" => "like" ) );
        $data = array(  );
        $result = $this->Article->parseCriteria($data);
        $this->assertEqual($result, array(  ));
        ...
        $this->assertEqual($result, $expected);
        $this->Article->filterArgs = array( array( "name" => "faketitle", "type" => "like", "field" => "Article.title" ) );
    ...
    {
        $this->Article->filterArgs = array( array( "name" => "tags", "type" => "subquery", "method" => "findByTags", "field" => "Article.id" ) );
        $data = array(  );
        $result = $this->Article->parseCriteria($data);
        $this->assertEqual($result, array(  ));
    ...
    {
        $this->Article->filterArgs = array( array( "name" => "filter", "type" => "query", "method" => "orConditions" ) );
        $data = array(  );
        $result = $this->Article->parseCriteria($data);
        $this->assertEqual($result, array(  ));
        $data = array( "filter" => "ticl" );
        $result = $this->Article->parseCriteria($data);
        $expected = array( "OR" => array( "Article.title LIKE" => "%ticl%", "Article.body LIKE" => "%ticl%" ) );
        $this->assertEqual($result, $expected);
    }
    ...
    public function testQueryWithBehaviorCallCondition()
    {
        ...
        $this->Article->filterArgs = array( array( "name" => "filter", "type" => "query", "method" => "mostFilterConditions" ) );
        $data = array(  );
        $result = $this->Article->parseCriteria($data);
        $this->assertEqual($result, array(  ));
    ...
    {
        $this->Article->filterArgs = array( array( "name" => "range", "type" => "expression", "method" => "makeRangeCondition", "field" => "Article.views BETWEEN ? AND ?" ) );
        $data = array(  );
        $result = $this->Article->parseCriteria($data);
        $this->assertEqual($result, array(  ));
        $data = array( "range" => "10" );
        ...
        $this->assertEqual($result, $expected);
        $this->Article->filterArgs = array( array( "name" => "range", "type" => "expression", "method" => "testThatInBehaviorMethodNotDefined", "field" => "Article.views BETWEEN ? AND ?" ) );
        $data = array( "range" => "10" );
        $result = $this->Article->parseCriteria($data);
        $this->assertEqual($result, array(  ));
    }
    ...
    public function testGetQuery()
    {
        ...
        $result = $this->Article->Tagged->recursive = 0 - 1;
