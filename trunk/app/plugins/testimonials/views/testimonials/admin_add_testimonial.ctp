...
<div class="ochead" >
    <div class="floatleft" id="breadcrumb">Add Testimonial</div>
		...
		<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
			<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
				...
				<tr class="odd_row">
					...
					<td width="1%" valign="top">:</td>
					<td><?php 
						echo $form->textarea($model.'.testimonial_description', array('label' => '','class'=>'ui-widget-content ui-corner-all','style'=>'width:600px;height:500px;'));
