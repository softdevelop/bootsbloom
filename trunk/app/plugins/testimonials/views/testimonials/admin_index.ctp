<div class="ochead" >
    <div class="floatleft" id="breadcrumb">Testimonials</div>
    <div class="floatright padtop_6px">
        <div class="floatleft " style="font-size:10px;">
            ...
            <?php echo $this->Html->link("Add New",array("action"=>"add_testimonial"),array("class"=>'add_lnk'));?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
...
<div class="pagging float_right ">
	...
	<?php echo $form->text('from_name',array('placeholder'=>'From Name','class'=>'status ui-widget-content ui-corner-all')); ?>&nbsp;&nbsp;
...
<?php echo $this->element("admin/testimonials_index"); ?>
