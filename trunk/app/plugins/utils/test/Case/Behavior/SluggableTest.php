...
class SluggableTest extends CakeTestCase
{
    ...
    {
        $this->Model->create(array( "SluggedArticle" => array( "title" => "Fourth Article" ) ));
        $this->Model->save();
    ...
    public function testSluggenerationBasedOnTrigger()
    {
        ...
        $this->Model->Behaviors->load("Sluggable", array( "trigger" => "generateSlug" ));
    ...
    {
        $this->Model->Behaviors->unload("Sluggable");
        $this->Model->Behaviors->load("Sluggable", array( "update" => true ));
