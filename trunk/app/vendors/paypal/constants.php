...
// define('API_USERNAME', 'kapil._1330611871_biz_api1.fullestop.com');

define('API_USERNAME', Configure::read('CONFIG_PAYPAL_API_USERNAME'));
//
...
define('API_PASSWORD', Configure::read('CONFIG_PAYPAL_API_PASSWORD'));

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', Configure::read('CONFIG_PAYPAL_API_SIGNATURE'));

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/
if(Configure::read('CONFIG_PAYPAL_MODE')=='sandbox'){
