        ...
        <tr>
            <td>
                <table class="content" >
                    <tr>
                        <td>
                            Dear <?php echo $project_detail['User']['name']; ?>,
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <strong><?php echo $user['name']; ?></strong> commented on your project  <a href='<?php echo $project_detail['Project']['link']; ?>'><?php echo $project_detail['Project']['title'];?></a>.
                        </td>
                    </tr>
                    <tr>
                        <td>
                          <?php echo $project_comment['ProjectComment']['comment']; ?>
                        </td>
                    </tr>
