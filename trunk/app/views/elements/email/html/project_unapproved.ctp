...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <title>Project Not Approved</title>
            ...
            <td>
                <table class="content">
                    ...
                    <tr class="word-wrap pt10 pb10">
                        <td>
                            Unfortunately, your project <?php echo $project_title; ?> was not approved.
                           </td>
                    </tr>
                    <tr>
                        <td>
                            For more details, please contact us by replying to this email.
                </table>   
            </td>
        </tr>
        <tr>
