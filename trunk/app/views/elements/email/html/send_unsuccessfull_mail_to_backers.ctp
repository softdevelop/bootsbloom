            ...
            <td>
                <table class="content">
                    ...
                    <tr class="word-wrap pt10 pb10">
                        <td>
							Unfortunately, project <?php echo ucfirst($projectname); ?> was not funded.
                        </td>
                    </tr>
                    <tr class="word-wrap pt10 pb10">
                        <td>
							<div>
								...
								On behalf of the creators of the project, we thank you for your support. Check out other projects on Boostbloom!<br/><br/>
								Thank you, <br/>
								Boostbloom
							</div>
                        </td>
