    ...
    foreach ($staff_projects as $staff_project) {
        ...
        <div class="fl mr25 mb15">
            ...
            <div class="listingbxmid height411" >
                <div class="pb14 ">
                    <?php 
                    echo $this->Html->link($this->Html->image($this->GeneralFunctions->show_project_image($staff_project['Project']['image'], "150px", "200"), array('height' => 150, 'width' => 200)), array('plugin' => false, 'controller' => 'projects', 'action' => 'detail', $staff_project['Project']['User']['slug'], $staff_project['Project']['slug']),array('title'=>$staff_project['Project']['title'],'escape'=>false)); 
                    ?>
                </div>
                <div class="grey13 height155 mb8 overflow" > 
                    <span class="blue14 block pb9">
                        <?php echo $this->Html->link(ucfirst(substr($staff_project['Project']['title'], 0, 30)), array('plugin' => false, 'controller' => 'projects', 'action' => 'detail', $staff_project['Project']['User']['slug'], $staff_project['Project']['slug']),array('title'=>$staff_project['Project']['title'])); ?>
                    </span>
                    <span class="block pb17 blue13"><?php __('frnt_by'); ?> <?php echo $this->Html->link(ucfirst($staff_project['Project']['User']['name']), array('plugin' => 'users', 'controller' => 'users', 'action' => 'profile', 'slug' => $staff_project['Project']['User']['slug'])); ?></span>
                    <?php echo ucfirst(substr($staff_project['Project']['short_description'], 0, 200)); ?>
                </div>
                <div class="clr"></div>
                <div class="mt29 ">
                    <?php
                    $total_pledge_amount = $this->GeneralFunctions->get_total_pledge_amount($staff_project['Project']['Backer']);
                    $total_funded_percentage = $this->GeneralFunctions->total_funded_percentage($staff_project['Project']['id'], $staff_project['Project']['funding_goal'], $staff_project['Project']['Backer']);
