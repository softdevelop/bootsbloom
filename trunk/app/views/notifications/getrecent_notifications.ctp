        ...
        if ($recentActivity['Notification']['notification_type'] == 'follow') {
            ...
            <li>
                ...
                if(isset($friend['User']['name'])) {
                    $div = '<div><div class="fl">' . $this->Html->image($this->GeneralFunctions->show_project_image($project['Project']['image'],'40px','40px'), array('height' => 40, 'width' => 40, 'escape' => false)) . '</div><div class="pl45 verticleTop"><strong>' . ucfirst($text->truncate( $project['Project']['title'], 40, array('ending' => '...', 'exact' => false, 'html' => true))). '</strong><br /><span class="pt10">'.$friend['User']['name'].' '.__('notification_comment_project_owner',true). '</span></div></div>';
                } else {
                    
                    $div = '<div><div class="fl">' . $this->Html->image($this->GeneralFunctions->show_project_image($project['Project']['image'],'40px','40px'), array('height' => 40, 'width' => 40, 'escape' => false)) . '</div><div class="pl45 verticleTop"><strong>' . ucfirst($text->truncate( $project['Project']['title'], 40, array('ending' => '...', 'exact' => false, 'html' => true))). '</strong><br /></div></div>';
                }
            ...
            <li>
                ...
                if(isset($friend['User']['name'])) {
                    ...
                    $div = '<div><div class="fl">' . $this->Html->image($this->GeneralFunctions->show_project_image($project['Project']['image'],'40px','40px'), array('height' => 40, 'width' => 40, 'escape' => false)) . '</div><div class="pl45 verticleTop"><strong>' . ucfirst($text->truncate( $project['Project']['title'], 40, array('ending' => '...', 'exact' => false, 'html' => true))). ' - Backed project has been cancelled </strong><br /></div></div>';
                }
            ...
            <li>
                ...
                if(isset($friend['User']['name'])) {
                    ...
                    $div = '<div><div class="fl">' . $this->Html->image($this->GeneralFunctions->show_project_image($project['Project']['image'],'40px','40px'), array('height' => 40, 'width' => 40, 'escape' => false)) . '</div><div class="pl45 verticleTop"><strong>' . ucfirst($text->truncate( $project['Project']['title'], 40, array('ending' => '...', 'exact' => false, 'html' => true))). ' project successfully funded </strong><br /></div></div>';
                }
				/*
				App::import('Model', 'Project');
				$projectModel = new Project();
                $proj = $projectModel->find("first", array(
					'conditions' => array("Project.slug"=>$project['Project']['slug'])
				));
				if($proj)
				*/
            ...
            <li>
                ...
                if(isset($friend['User']['name'])) {
                    ...
                    $div = '<div><div class="fl">' . $this->Html->image($this->GeneralFunctions->show_project_image($project['Project']['image'],'40px','40px'), array('height' => 40, 'width' => 40, 'escape' => false)) . '</div><div class="pl45 verticleTop"><strong>' . ucfirst($text->truncate( $project['Project']['title'], 40, array('ending' => '...', 'exact' => false, 'html' => true))). ' project not successfully funded </strong><br /></div></div>';
                }
            ...
            <li>
                ...
                if(isset($friend['User']['name'])) {
                    ...
                    $div = '<div><div class="fl">' . $this->Html->image($this->GeneralFunctions->show_project_image($project['Project']['image'],'40px','40px'), array('height' => 40, 'width' => 40, 'escape' => false)) . '</div><div class="pl45 verticleTop"><strong>'. ucfirst($text->truncate( $project['Project']['title'], 40, array('ending' => '...', 'exact' => false, 'html' => true))). ' will ends in just 48 hours. </strong><br /></div></div>';
                }
