...
<div class="ochead" >
    ...
    <div class="floatright padtop_6px">
        <?php if (isset($user_id)) { ?>
            <div class="floatleft" style="font-size:11px;"></div>
        <?php } ?>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
...
<div class="pagging float_right">
    <?php echo $this->Form->create('Project', array('action' => 'pending_projects'));
    ?>
...
<?php echo $this->element('admin/cancellation_requests'); ?>
