...
<?php
//pr($project_update_detail);
echo $this->element('project_tabs');
?> 
    ...
    <?php echo $this->Html->image('front/ajax-loader.gif'); ?>
                                    ...
                                    <div id="loadContentId" class='loadmore'>
                                        ...
                                        if ($current_page != $last_page) {
                                            echo $this->Html->link($this->Html->tag('span', __('Load More', true)), array('plugin' => false, 'controller' => 'projects', 'action' => 'project_update_detail', $project_detail['User']['slug'], $project_detail['Project']['slug'], $project_update_detail['ProjectUpdate']['id'] . '/' . 'page' => $page), array('escape' => false, 'class' => 'loadmoreicon', 'id' => 'loadMoreContent'));
                                        }
                                        ?>
                                    </div>
                        <?php } ?>
                        ...
                        if (isset($user_check)) {
                            ?>
                                ...
                                <?php echo $this->Form->create($model, array('url' => array('plugin' => false, 'controller' => 'projects', 'action' => 'project_update_detail', $project_detail['User']['slug'], $project_detail['Project']['slug'], $project_update_detail['ProjectUpdate']['id']))); ?>
                            <div>
