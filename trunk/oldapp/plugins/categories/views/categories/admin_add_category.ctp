...
<div class="ochead">
    ...
    <div class="floatleft padtop_20px">
        <?php
        if (isset($parent_category_name)) {
            echo $parent_category_name . "'s Subcategory";
        } else {
            echo "New Category";
        }
        ?>
    ...
    <div class="floatright padtop_6px">
        ...
        <div class="floatleft padright_10px" style="font-size:10px;">
            ...
            <?php echo $this->Html->link("Back To Categories", array("plugin" => "categories", "controller" => "categories", "action" => "index", $parent_id), array("class" => 'back_lnk')); ?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
