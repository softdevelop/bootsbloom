    ...
    <div id="tab1" class="tab_content">
        <div class="wrapper">
            ...
            <div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <?php
                echo $this->Form->create($model, array('url' => array('plugin' => 'help_categories', 'controller' => 'faq_posts', 'action' => 'edit_faq_post', $id, $parent_id, 'eng')));
...
<?php /* second tab start here * */ ?>
    <div id="tab2" class="tab_content">
        <div class="wrapper">
            ...
            <div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <?php
                echo $this->Form->create($model, array('url' => array('plugin' => 'help_categories', 'controller' => 'faq_posts', 'action' => 'edit_faq_post', $id, $parent_id, 'hy')));
                echo $form->hidden("parent_id");
                echo $form->hidden("id");
                ?>
                <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
