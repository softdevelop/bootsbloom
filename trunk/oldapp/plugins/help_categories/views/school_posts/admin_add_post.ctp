...
<div class="ochead">
    ...
    <div class="floatright padtop_6px">
        <div class="floatleft padright_10px" style="font-size:10px;">
            <?php echo $this->Html->link("Back To Categories", array("plugin" => "help_categories", "controller" => "school_posts", "action" => "index", $parent_id), array("class" => 'back_lnk')); ?>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
...
<div class="tab_container">
    <div id="tab1" class="tab_content">
        <div class="wrapper">	
            <div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <?php echo $this->Form->create($model, array('url' => array('plugin' => 'help_categories', 'controller' => 'school_posts', 'action' => 'add_post', $parent_id, 'eng')));
                ?>
    ...
    <div id="tab2" class="tab_content">
        <div class="wrapper">	
            <div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
                <?php echo $this->Form->create($model, array('url' => array('plugin' => 'help_categories', 'controller' => 'school_posts', 'action' => 'add_post', $parent_id, 'hy')));
