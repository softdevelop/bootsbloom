...
<div class="ochead" >
    <div class="floatleft" id="breadcrumb">Add New Newsletter </div>
	...
	<div class="clear"><?php echo $html->image('admin/dot.gif',array('alt'=>'','width'=>'1px','height'=>'10px'));?></div>
		<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
			<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
				...
				<tr class="even_row">
					<td align='left' width="19%" valign="top" class="padding_left_40">Newsletter Image<font color='red'>*</font></td>
					<td width="1%" valign="top">:</td>
					<td > <?php echo $form->file($model.".newsletter_images", array("class" => "ui-widget-content ui-corner-all")); ?>
					</td>
					<td width="30%" valign="middle">
