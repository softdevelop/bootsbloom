...
<div class="ochead" >
	<div class="floatleft" id="breadcrumb"><?php echo __('Edit Curated Page'); ?></div>
...
<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
	<table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
		...
		<tr class="odd_row">
			...
			<td width="1%" valign="top">:</td>
			<td > <?php echo $form->file("partner_image", array("class" => "ui-widget-content ui-corner-all")); ?>
			<span style="padding-left:0px;">
			<?php echo $this->Form->hidden('Partner.image_update',array('value'=>$partner_logo));
					echo $this->Html->image(UPLOAD_DIR_URL.$partner_logo,array('width'=>'50px','height'=>'50px')); ?></span>
			</td>
			<td width="30%" valign="middle">
			<?php  if(isset($this->validationErrors[$model]['partner_image'])){ ?>
				<div  class="errormsg">
				  <div class="floatleft padright_10px padtop_4px"><img src="<?php echo WEBSITE_URL;?>img/error_icon.gif" width="10" height="10" alt="" /></div>
				  <div class="floatleft"><?php echo $this->validationErrors[$model]['partner_image'];?></div>
				  <div class="clear"></div>
				  <div class="errtl"></div>
				  <div class="errtr"></div>
				  <div class="errbl"></div>
		...
		<td width="1%" valign="top">:</td>
		<td><?php echo $form->input('active',array('label' => '','options' => array('0'=>'Inactive','1'=>'Active'), null,'class'=>'ui_dropdown')); ?>
		</td>
		<td width="30%" valign="middle">
