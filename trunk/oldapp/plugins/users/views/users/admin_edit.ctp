...
?>
<div class="ochead">
    <div class="floatleft padtop_20px">Edit User</div>
...
<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr class="odd_row">
            <td align='left' width="19%" valign="top" class="padding_left_40">Password</td>
            <td width="1%" valign="top">:</td>
        ...
        <tr class="even_row">
            <td align='left' width="19%" valign="top" class="padding_left_40">Confirm Password</td>
            <td width="1%" valign="top">:</td>
        ...
        <tr class="even_row">
            <td align='left' valign="top" class="padding_left_40">Status<font color='red'>*</font></td>
            <td width="1%" valign="top">:</td>
            <td>
                <?php
