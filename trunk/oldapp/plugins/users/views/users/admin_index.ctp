...
<div class="pagging float_right ">
    <?php echo $this->Form->create($model, array('class' => ''));
        echo $form->text("name", array("class" => "status ui-widget-content ui-corner-all",'value' =>'Name OR Email', "onclick" => "if (this.value == 'Name OR Email') this.value = ''", "onblur" => "if (this.value == '') this.value = 'Name OR Email'")); ?>
    &nbsp;&nbsp;
