<div class="ochead">
    <div class="floatleft padtop_20px">My Account</div>
...
<?php echo $this->Form->create($model, array('url' => array('plugin' => 'users', 'controller' => 'users', 'action' => 'myaccount'))); ?>
...
<div  class="ui-tabs ui-widget ui-widget-content ui-corner-all">
    <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
        ...
        <tr class="odd_row">
            ...
            <td width="1%" valign="top">:</td>
            <td > <?php echo $form->password($model . ".password", array("class" => "ui-widget-content ui-corner-all", 'autoComplete' => 'off')); ?></td>
            <td width="30%" valign="middle">
