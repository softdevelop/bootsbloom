                    ...
                    <div>
                        <div id="loading_content">
                            <?php if ($following_users) {
                                echo $this->element('front/load_following_friends');
                                } else { ?>
                        ...
                        <div class="clr"></div>
                        <?php if($following_users){ ?>
                           <div id="loadmore_loader" class="aligncenter" style="display: none;"><?php echo $this->Html->image('front/ajax-loader.gif'); ?>
                                </div>
                                <div id="loadContentId" class='loadmore'>
                                    <?php
                                    if ($current_page != $last_page) {
                                        echo $this->Html->link($this->Html->tag('span', __('blog_load_more', true)), array('plugin' => 'users', 'controller' => 'users', 'action' => 'following', 'page' => $page), array('escape' => false, 'class' => 'loadmoreicon', 'id' => 'loadMoreContent'));
                                    }
                                    ?>
                                </div>
                    <?php } ?>
