<div id="mainnav">
    <ul class="topnav">
        ...
        <li>
            ...
            <?php echo $this->Html->link("Blogs", array("plugin" => "blogs", "controller" => "blogs", "action" => "blog_dashboard"), array("class" => "top_menu_links", 'escape' => false)); ?>

            <ul class="subnav">
                <li>
                    <?php
                    echo $this->Html->link('Blog', array('plugin' => 'blogs', 'controller' => 'blogs', 'action' => 'index'), array('class' => 'top_menu_links', 'escape' => false));
                    ?> 
                </li>

                <li>
                    <?php
                    echo $this->Html->link('Awaiting Comments', array('plugin' => 'blogs', 'controller' => 'blog_post_comments', 'action' => 'awaiting_comments'), array('class' => 'top_menu_links', 'escape' => false));
                    ?> 
                </li>
				
                <li>
                    <?php
                    echo $this->Html->link('Projects We Love', array('plugin' => 'blogs', 'controller' => 'blog_fav_projects', 'action' => 'index'), array('class' => 'top_menu_links', 'escape' => false));
                    ?> 
                </li>				
            </ul>
        </li> 
        ...
        <li>
            ...
            <ul class="subnav">
                <li>
                    <?php echo $this->Html->link('Templates', array('plugin' => 'newsletters', 'controller' => 'newsletters', 'action' => 'index'), array('class' => 'top_menu_links', 'escape' => false)); ?> 
                </li>
                <li>
                    <?php echo $this->Html->link('Subscribers', array('plugin' => 'newsletters', 'controller' => 'subscribers', 'action' => 'index'), array('class' => 'top_menu_links', 'escape' => false)); ?> 
                </li>
            </ul>
        </li>
        <?php /*         * ***************Utilites************* */ ?>
        ...
        <li>
            <?php
            echo $this->Html->link('Manage Cities', array('plugin' => false, 'controller' => 'cities', 'action' => 'index'), array('class' => 'top_menu_links', 'escape' => false));
            ?> 
        </li>
    </ul>
