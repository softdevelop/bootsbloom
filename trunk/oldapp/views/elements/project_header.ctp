<div id="header">
    <div class="blackbg">
        <div class="wrapper">
            <div class="fl">
                <?php echo $this->Html->link(Configure::read('CONFIG_SITE_TITLE'), array('plugin' => '', 'controller' => 'home', 'action' => 'index'), array("class" => "sprite projectlogo")); ?>

                <span class="white15 fl ml24 mt27"><?php __('header_punch_line'); ?></span>
                <div class="clr"></div>
            </div>
            <div class="fr mt8">
                <div>
