	...
	<div class="content">
		...
		<div class="grey-frame">
			<div class="grey-frame-inner">
				...
				<h2>Dear <?php echo ucfirst($project_content['User']['name']);?>,</h2>
				<p><?php echo vsprintf(__('project_under_review',true),array($project_content['Project']['title'],  Configure::read('CONFIG_SITE_TITLE'))) ;?> </p>
				<p><?php __('thank_for_patience');?></p>
