...
<div class="darkgreybg">
    <div class="blackshade pt10">
        <div class="wrapper">
            <div class="fl whitearial15 pt20 pl10"><?php __('frnt_punch_line'); ?> &nbsp;</div>
            <div class="fl sprite whitearrow"></div>
            <div class="fl" style="margin-left: 5px;">
                <?php echo $this->Html->link(__('project_start_your_project', true), array('plugin' => false, 'controller' => 'home', 'action' => 'start'), array('class' => 'button_yellow ie_radius fl')); ?>
                <?php echo $this->Html->link(__('frnt_discover_grate_project', true), array('plugin' => false, 'controller' => 'projects', 'action' => 'discover'), array('class' => 'button_blue ie_radius fl ml10')); ?>
            </div>
            <div class="fl"></div>
            <div class="clr"></div>
        </div>
