...
<?php if (count($popular) > 0) { ?>
    <?php foreach ($popular as $pop_proejct) { ?>
        <div class="slide" style="float: left; width: 230px;">
            ...
            <div class="listingbxmid">
                <div class="pb14 pl251">
                    <?php 
                    echo $this->Html->link($this->Html->image($this->GeneralFunctions->show_project_image($pop_proejct['Project']['image'], "150px", "200"), array('height' => 150, 'width' => 200)), array('plugin' => false, 'controller' => 'projects', 'action' => 'detail', $pop_proejct['Project']['User']['slug'], $pop_proejct['Project']['slug']),array('title'=>$pop_proejct['Project']['title'],'escape'=>false)); 
                    ?>
                </div>
                <div class="grey13 height155 pt142"> 
                    <span class="blue14 block pb9"><?php echo $this->Html->link(ucfirst(substr($pop_proejct['Project']['title'], 0, 45)), array('plugin' => false, 'controller' => 'projects', 'action' => 'detail', $pop_proejct['Project']['User']['slug'], $pop_proejct['Project']['slug'])); ?></span> 
                    <span class="block pb17 blue13"><?php __('frnt_by'); ?> 
					<?php echo $this->Html->link(ucfirst($pop_proejct['Project']['User']['name']), array('plugin' => 'users', 'controller' => 'users', 'action' => 'profile', 'slug' => $pop_proejct['Project']['User']['slug'])); ?></span> 
                    <?php echo ucfirst(substr($pop_proejct['Project']['short_description'], 0, 200)); ?>
                </div>
                <div class="mt29 pb10">
                    <?php
        ...
        <?php if (($pop_proejct['Project']['project_end_date'] < time()) && ($total_pledge_amount >= $pop_proejct['Project']['funding_goal'])) { ?>
                    ...
                    if (($pop_proejct['Project']['project_end_date'] < time()) && ($total_pledge_amount < $pop_proejct['Project']['funding_goal'])) {
                        ?>
                    ...
                    if ($pop_proejct['Project']['project_end_date'] > time()) { ?>                         
                        <!-- Slider Bar -->
                        <div class="" >
        ...
        <?php } ?>
                        ...
                        <div class="fl pl10 pr10"><strong>$<?php echo $total_pledge_amount; ?></strong> <br>
